...
class CourseTests(TestCase):
    ...
    def test_course_list(self): 
        ...
        self.assertEqual(response.context['courses'][0].name, 
                         course1.name) 
        self.assertEqual(response.context['courses'][1].name, 
                         course2.name) 

        self.assertEqual(response.context['courses'][0].short_description, 
                         course1.short_description) 
        self.assertEqual(response.context['courses'][1].short_description, 
	...
	"""
        ...
        self.assertEqual(response.context['object'].trainer.user, 
                         self.u1)
        self.assertEqual(response.context['object'].assistant.user, 
                         self.u2)

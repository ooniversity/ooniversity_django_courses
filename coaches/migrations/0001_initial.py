    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(max_length=1, verbose_name=b'Gender', choices=[(b'M', b'Man'), (b'W', b'Woman')])),
                ...
                ('discription', models.TextField(null=True, verbose_name=b'Coach discription', blank=True)),
